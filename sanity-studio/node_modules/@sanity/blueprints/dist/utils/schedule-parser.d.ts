 ...
 * @internal
 */
export declare function validateScheduleExpression(expression: string): BlueprintError[];
/**
 ...
 * @internal
 */
export declare function parseScheduleExpression(expression: string): string;
