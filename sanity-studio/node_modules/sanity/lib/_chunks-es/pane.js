...
const usePublishAction = (props) => {
  ...
  const doPublish = t5;
  let t6;
  $[19] !== doPublish || $[20] !== hasValidationErrors || $[21] !== isSyncing || $[22] !== publishScheduled || $[23] !== revision || $[24] !== t || $[25] !== toast || $[26] !== validationStatus.isValidating || $[27] !== validationStatus.revision ? (t6 = () => {
  ...
  }, $[19] = doPublish, $[20] = hasValidationErrors, $[21] = isSyncing, $[22] = publishScheduled, $[23] = revision, $[24] = t, $[25] = toast, $[26] = validationStatus.isValidating, $[27] = validationStatus.revision, $[28] = t6) : t6 = $[28];
  let t7;
  $[29] !== doPublish || $[30] !== hasValidationErrors || $[31] !== isSyncing || $[32] !== isValidating || $[33] !== publishScheduled || $[34] !== revision || $[35] !== t || $[36] !== toast || $[37] !== validationStatus.isValidating || $[38] !== validationStatus.revision ? (t7 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating, toast, t], $[29] = doPublish, $[30] = hasValidationErrors, $[31] = isSyncing, $[32] = isValidating, $[33] = publishScheduled, $[34] = revision, $[35] = t, $[36] = toast, $[37] = validationStatus.isValidating, $[38] = validationStatus.revision, $[39] = t7) : t7 = $[39], useEffect(t6, t7);
  let t8;
  ...
  let t9;
  $[43] !== changesOpen || $[44] !== currentPublishRevision || $[45] !== publishState ? (t9 = [changesOpen, publishState, currentPublishRevision], $[43] = changesOpen, $[44] = currentPublishRevision, $[45] = publishState, $[46] = t9) : t9 = $[46], useEffect(t8, t9);
  ...
  bb0: {
    ...
    if (published && !draft && !version) {
      let t122;
      $[56] !== t ? (t122 = t("action.publish.label"), $[56] = t, $[57] = t122) : t122 = $[57];
      const t132 = published?._updatedAt;
      let t142;
      $[58] !== t || $[59] !== t132 ? (t142 = getDisabledReason("ALREADY_PUBLISHED", t132, t), $[58] = t, $[59] = t132, $[60] = t142) : t142 = $[60];
      let t152;
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      let t122;
      $[64] !== t ? (t122 = t("action.publish.label"), $[64] = t, $[65] = t122) : t122 = $[65];
      let t132;
      $[66] !== currentUser ? (t132 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[66] = currentUser, $[67] = t132) : t132 = $[67];
      let t142;
    ...
    let t13;
    $[71] !== publishScheduled || $[72] !== publishState?.status || $[73] !== t ? (t13 = publishState?.status === "published" ? t("action.publish.published.label") : publishScheduled ? t("action.publish.validation-in-progress.label") : publishState?.status === "publishing" ? t("action.publish.running.label") : t("action.publish.draft.label"), $[71] = publishScheduled, $[72] = publishState?.status, $[73] = t, $[74] = t13) : t13 = $[74];
    let t14;
    $[75] !== publishScheduled || $[76] !== publishState?.status || $[77] !== t || $[78] !== title ? (t14 = publishScheduled ? t("action.publish.waiting") : publishState?.status === "published" || publishState?.status === "publishing" ? null : title, $[75] = publishScheduled, $[76] = publishState?.status, $[77] = t, $[78] = title, $[79] = t14) : t14 = $[79];
