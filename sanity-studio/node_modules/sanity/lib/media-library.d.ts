import * as _sanity_types33 from "@sanity/types";
...
declare function defineVideoField(definition: Omit<VideoDefinition$1, 'type'> & FieldDefinitionBase): {
  ...
  preview?: _sanity_types33.PreviewConfig<Record<string, string>, Record<string, any>> | undefined;
} & FieldDefinitionBase & _sanity_types33.WidenValidation & _sanity_types33.WidenInitialValue;
