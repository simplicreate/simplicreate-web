...
/** @internal */
declare function ConfirmDeleteDialogContainer(props: ConfirmDeleteDialogProps): react647.JSX.Element;
interface PaneProps {
  children?: ReactNode;
 ...
 * @internal
 */
declare const Pane: react647.ForwardRefExoticComponent<Omit<PaneProps & Omit<CardProps, "as" | "overflow"> & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "hidden" | "id" | "style">, "ref"> & react647.RefAttributes<HTMLDivElement>>;
 ...
 * @internal
 */
declare const PaneContent: react647.ForwardRefExoticComponent<PaneContentProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & react647.RefAttributes<HTMLDivElement>>;
/**
 *
 * @hidden
 ...
 * @beta This API will change. DO NOT USE IN PRODUCTION.
 */
declare function PaneLayout(props: PaneLayoutProps & CardProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref' | 'wrap'>): react647.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @internal
 */
declare const DocumentPane: react647.NamedExoticComponent<DocumentPaneProviderProps>;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const DocumentPaneProviderWrapper: react647.MemoExoticComponent<(props: DocumentPaneProviderProps) => react647.JSX.Element>;
/**
...
/** @internal */
declare function DocumentInspectorHeader(props: DocumentInspectorHeaderProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref'>): react647.JSX.Element;
/** @internal */
declare function useDocumentPane(): DocumentPaneContextValue;
/**
 * @internal
 */
declare const PaneContainer: react647.NamedExoticComponent<BaseStructureToolPaneProps<"documentList">>;
/**
 * @internal
 */
