...
/** @internal */
declare function BetaBadge(props: BetaBadgeProps & Omit<HTMLProps<HTMLDivElement>, 'ref'>): react597.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const CommandList: react597.NamedExoticComponent<CommandListProps<any> & react597.RefAttributes<CommandListHandle>>;
 ...
 * @internal
 */
declare const Button: react597.ForwardRefExoticComponent<(Omit<Pick<ButtonProps, "as" | "icon" | "iconRight" | "justify" | "loading" | "mode" | "paddingLeft" | "paddingY" | "selected" | "tone" | "type" | "width"> & {
  ...
  size?: "default" | "large" | undefined;
  radius?: "full" | undefined;
} & IconButton & Omit<HTMLProps<HTMLButtonElement>, "as" | "size" | "title">, "ref">) & react597.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ContextMenuButton: react597.ForwardRefExoticComponent<ContextMenuButtonProps & Pick<HTMLProps<HTMLButtonElement>, "disabled" | "hidden" | "onClick"> & react597.RefAttributes<HTMLButtonElement>>;
/**
 ...
 * @internal
 */
declare const Chip: react597.ForwardRefExoticComponent<Omit<Omit<_sanity_ui17.ButtonProps & Omit<react597.HTMLProps<HTMLButtonElement>, "as" | "width">, "ref"> & react597.RefAttributes<HTMLButtonElement>, "ref"> & react597.RefAttributes<unknown>>;
/**
 *
 ...
 * @internal
 */
declare const VersionChip: react597.NamedExoticComponent<{
...
/** @internal */
declare function ChangeIndicator(props: ChangeIndicatorProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react597.JSX.Element;
/** @internal */
...
declare function ChangeConnectorRoot({
  ...
  onSetFocus,
  ...restProps
}: ChangeConnectorRootProps): react597.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const ChangeIndicatorsTracker: react597.MemoExoticComponent<typeof ChangeIndicatorsTrackerComponent>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare function CommentDeleteDialog(props: CommentDeleteDialogProps): react597.JSX.Element;
/**
 * @internal
 */
declare const CommentDisabledIcon: react597.ForwardRefExoticComponent<Omit<SVGProps<SVGSVGElement>, "ref"> & react597.RefAttributes<SVGSVGElement>>;
/**
 *
 ...
 * @hidden
 */
declare function LocaleProvider(props: PropsWithChildren): react597.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * @public
 */
declare function Translate(props: TranslationProps): react597.JSX.Element;
 ...
 * while reconnecting.
 */
declare function CommentsAuthoringPathProvider(props: CommentsAuthoringPathProviderProps): react597.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @beta
 */
declare const CommentsProvider: react597.NamedExoticComponent<CommentsProviderProps>;
 ...
 * @hidden
 */
declare const CommentsEnabledProvider: react597.NamedExoticComponent<CommentsEnabledProviderProps>;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsIntentProvider: react597.NamedExoticComponent<CommentsIntentProviderProps>;
 ...
 * @internal
 */
declare const CommentsSelectedPathProvider: react597.NamedExoticComponent<CommentsSelectedPathProviderProps>;
/**
 * @internal
 */
...
}: ActiveWorkspaceMatcherProps): react597.JSX.Element;
/** @internal */
...
declare function WorkspacesProvider({
  ...
  basePath,
  LoadingComponent
}: WorkspacesProviderProps): react597.JSX.Element;
/** @internal */
 ...
 * @hidden
 */
declare function AddonDatasetProvider(props: AddonDatasetSetupProviderProps): string | number | bigint | boolean | react597.JSX.Element | Iterable<react597.ReactNode> | Promise<string | number | bigint | boolean | Iterable<react597.ReactNode> | react597.ReactElement<unknown, string | react597.JSXElementConstructor<any>> | react597.ReactPortal | null | undefined> | null | undefined;
/**
 * @beta
 * @hidden
 */
...
declare function ColorSchemeProvider({
  ...
  onSchemeChange,
  scheme: schemeProp
}: ColorSchemeProviderProps): react597.JSX.Element;
/**
...
declare function ColorSchemeLocalStorageProvider({
  children,
  onSchemeChange
}: Pick<ColorSchemeProviderProps, 'children' | 'onSchemeChange'>): react597.JSX.Element;
/**
 ...
 * @internal
 */
declare const SearchHeader: react597.ForwardRefExoticComponent<SearchHeaderProps & react597.RefAttributes<HTMLInputElement>>;
...
declare function SearchPopover({
  ...
  previewPerspective,
  open
}: SearchPopoverProps): react597.JSX.Element;
...
declare function SearchResultItemPreview({
  ...
  showBadge,
  perspective
}: SearchResultItemPreviewProps): react597.JSX.Element;
/**
 * @internal
 */
...
declare function SearchProvider({
  ...
  disabledDocumentIds,
  canDisableAction
}: SearchProviderProps): react597.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const SearchButton: react597.ForwardRefExoticComponent<SearchButtonProps & react597.RefAttributes<HTMLButtonElement>>;
...
declare function SearchDialog({
  ...
  onOpen,
  open
}: SearchDialogProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioLogo(props: LogoProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function StudioNavbar(props: Omit<NavbarProps, 'renderDefault'>): react597.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioToolMenu(props: ToolMenuProps): react597.JSX.Element | null;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare const ToolLink: react597.ForwardRefExoticComponent<Omit<ToolLinkProps & Omit<HTMLProps<HTMLAnchorElement>, "href" | "name">, "ref"> & react597.RefAttributes<HTMLAnchorElement>>;
/**
 * @hidden
 * @beta */
...
declare function SourceProvider({
  children,
  ...props
}: SourceProviderProps): react597.JSX.Element;
/**
 * @internal
...
declare function StudioAnnouncementsCard({
  ...
  onCardClick,
  onCardDismiss
}: StudioAnnouncementCardProps): react597.JSX.Element;
...
declare function StudioAnnouncementsDialog({
  ...
  onClose,
  mode
}: StudioAnnouncementDialogProps): react597.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * ```
 */
declare function StudioLayout(): react597.JSX.Element;
/**
 * @internal
 * The default Studio Layout component
 * */
declare function StudioLayoutComponent(): react597.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: StudioProviderProps): react597.JSX.Element;
 ...
 * @internal
 */
declare function UpsellDescriptionSerializer(props: DescriptionSerializerProps): react597.JSX.Element;
/** @internal */
...
declare function ErrorMessage({
  ...
  path,
  stack
}: ErrorMessageProps): react597.JSX.Element;
...
declare function WorkspaceLoaderBoundary({
  ...
  ...props
}: WorkspaceLoaderProps): react597.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsList: react597.NamedExoticComponent<CommentsListProps & react597.RefAttributes<HTMLDivElement>>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare const CommentInput: react597.ForwardRefExoticComponent<CommentInputProps & react597.RefAttributes<CommentInputHandle>>;
 ...
 * @internal
 */
declare const CommentInlineHighlightSpan: react597.ForwardRefExoticComponent<Omit<CommentInlineHighlightSpanProps & react597.HTMLProps<HTMLSpanElement>, "ref"> & react597.RefAttributes<HTMLSpanElement>>;
/**
 * @internal
 * @hidden
 */
...
/** @internal */
declare const CollapseMenu: react597.ForwardRefExoticComponent<CollapseMenuProps & react597.RefAttributes<any>>;
/** @internal */
declare const AutoCollapseMenu: react597.ForwardRefExoticComponent<Omit<CollapseMenuProps, "children" | "collapsed"> & {
  menuOptions: react597.JSX.Element[];
} & react597.RefAttributes<HTMLDivElement>>;
/** @internal */
...
/** @internal */
declare const CollapseMenuButton: react597.ForwardRefExoticComponent<Omit<CollapseMenuButtonProps & Omit<HTMLProps<HTMLButtonElement>, "as" | "size">, "ref"> & react597.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ScrollContainer: react597.NamedExoticComponent<Omit<ScrollContainerProps<ElementType>, "ref"> & react597.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function EventsProvider({
  value,
  children
}: EventsProviderProps): react597.JSX.Element;
/**
 * @internal
 */
...
/** @internal */
declare function ChangeResolver(props: ChangeResolverProps): react597.JSX.Element | null;
/**
 * @internal
 * */
...
/** @internal */
declare const DiffCard: react597.ForwardRefExoticComponent<Omit<DiffCardProps & Omit<HTMLProps<HTMLElement>, "as" | "height">, "ref"> & react597.RefAttributes<unknown>>;
/** @internal */
...
declare class DiffErrorBoundary extends Component<DiffErrorBoundaryProps, DiffErrorBoundaryState> {
  ...
  render(): string | number | bigint | boolean | react597.JSX.Element | Iterable<ReactNode> | Promise<string | number | bigint | boolean | Iterable<ReactNode> | react597.ReactElement<unknown, string | react597.JSXElementConstructor<any>> | react597.ReactPortal | null | undefined> | null | undefined;
}
/** @internal */
...
/** @internal */
declare function DiffFromTo(props: DiffFromToProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare function DiffTooltip(props: DiffTooltipProps | DiffTooltipWithAnnotationsProps): react597.JSX.Element;
...
declare function Event$1({
  event,
  showChangesBy
}: TimelineItemProps): react597.JSX.Element;
/** @internal */
...
declare function FieldChange(props: {
  ...
  hidden?: boolean;
  addParentWrapper?: boolean;
} & HTMLAttributes<HTMLDivElement>): react597.JSX.Element | null;
/** @internal */
type FromToProps = {
  align?: 'top' | 'center' | 'bottom';
  layout?: 'grid' | 'inline';
...
/** @internal */
declare const FromTo: react597.ForwardRefExoticComponent<Omit<FromToProps, "ref"> & react597.RefAttributes<HTMLDivElement>>;
/** @internal */
type FromToArrowDirection = 'down' | 'right';
/** @internal */
declare function FromToArrow(props: {
  direction?: FromToArrowDirection;
} & TextProps & Omit<HTMLProps<HTMLDivElement>, 'children' | 'ref'>): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare function MetaInfo(props: MetaInfoProps): react597.JSX.Element;
/** @internal */
declare function NoChanges(): react597.JSX.Element;
/** @internal */
declare const RevertChangesButton: react597.ForwardRefExoticComponent<Omit<ButtonProps$1, "tooltipProps"> & Omit<HTMLProps<HTMLButtonElement>, "ref"> & {
  changeCount: number;
} & react597.RefAttributes<HTMLButtonElement>>;
...
declare function RevertChangesConfirmDialog({
  ...
  changeCount,
  referenceElement
}: RevertChangesConfirmDialogProps): react597.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function EditScheduleForm(props: PropsWithChildren<Props$2>): react597.JSX.Element;
/**
 * @internal
 */
...
declare function useScheduleAction(props: DocumentActionProps): {
  disabled: true;
  icon: react597.ForwardRefExoticComponent<Omit<react597.SVGProps<SVGSVGElement>, "ref"> & react597.RefAttributes<SVGSVGElement>>;
  label: string;
  title: react597.JSX.Element;
  onHandle?: undefined;
  dialog?: undefined;
} | {
  ...
  icon: react597.ForwardRefExoticComponent<Omit<react597.SVGProps<SVGSVGElement>, "ref"> & react597.RefAttributes<SVGSVGElement>>;
  onHandle: () => void;
  title: "" | react597.JSX.Element | null;
} | null;
...
/** @internal */
declare function GetHookCollectionState<Args, State>(props: GetHookCollectionStateProps<Args, State>): react597.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: SingleDocReleaseProviderProps): react597.JSX.Element;
/**
...
declare function DocumentStatus({
  ...
  versions,
  singleLine
}: DocumentStatusProps$1): react597.JSX.Element;
/**
 * @internal
 */
...
declare function DocumentStatusIndicator({
  ...
  published,
  versions
}: DocumentStatusProps): react597.JSX.Element;
/**
 * @internal
 */
...
declare function Hotkeys({
  ...
  keys: hotKeys,
  ...props
}: HotkeysProps$1): react597.JSX.Element;
/** @internal */
...
declare function InsufficientPermissionsMessage({
  currentUser,
  context
}: InsufficientPermissionsMessageProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function IntentButton(props: IntentLinkProps & ButtonProps$1 & Omit<HTMLProps<HTMLButtonElement>, 'ref' | 'size' | 'as'>): react597.JSX.Element;
...
declare function LoadingBlock({
  ...
  showText,
  title
}: LoadingTestProps): react597.JSX.Element;
...
/** @internal */
declare function PopoverDialog(props: PopoverDialogProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare const PreviewCard: react597.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react597.RefAttributes<HTMLDivElement>>;
/**
 ...
 * @internal
 */
declare const ReferenceInputPreviewCard: styled_components_dist_types6.IStyledComponentBase<"web", styled_components4.FastOmit<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react597.RefAttributes<HTMLDivElement>, never>> & string & Omit<react597.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react597.RefAttributes<HTMLDivElement>>, keyof react597.Component<any, {}, any>>;
/**
 ...
 * @hidden
 * @beta */
declare function CompactPreview(props: CompactPreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DefaultPreview(props: DefaultPreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DetailPreview(props: DetailPreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function MediaPreview(props: MediaPreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function BlockImagePreview(props: BlockImagePreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
declare function BlockPreview(props: Omit<PreviewProps<'block'>, 'renderDefault'>): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function InlinePreview(props: InlinePreviewProps): react597.JSX.Element;
 ...
 * @hidden
 * @beta */
declare function TemplatePreview(props: TemplatePreviewProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
...
declare function RelativeTime({
  time,
  ...options
}: RelativeTimeProps): react597.JSX.Element;
 ...
 */
declare function Resizable(props: ResizableProps & BoxProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react597.JSX.Element;
/**
 * @hidden
 * @beta */
...
/** @hidden @beta */
declare const StatusButton: react597.ForwardRefExoticComponent<(StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, "disabled" | "ref" | "size" | "title">) & react597.RefAttributes<HTMLButtonElement>>;
/** @internal */
...
/** @internal */
declare const TextWithTone: react597.ForwardRefExoticComponent<Omit<TextWithToneProps, "ref"> & react597.RefAttributes<HTMLDivElement>>;
/** @internal */
declare const TooltipOfDisabled: react597.ForwardRefExoticComponent<Omit<_sanity_ui17.TooltipProps, "arrow" | "padding" | "shadow"> & {
 ...
 */
declare const ImperativeToast: react597.ForwardRefExoticComponent<react597.RefAttributes<unknown>>;
/**
 ...
 * @hidden
 * @beta */
declare function UserAvatar(props: UserAvatarProps): react597.JSX.Element;
/**
 * @internal
...
/** @internal */
declare const FormCallbacksProvider: react597.NamedExoticComponent<FormCallbacksValue & {
  children: ReactNode;
}>;
/** @internal */
 ...
 * @alpha
 */
declare function FormBuilder(props: FormBuilderProps): react597.JSX.Element;
/**
 ...
 * @alpha This API might change.
 */
declare function FormProvider(props: FormProviderProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioCrossDatasetReferenceInput(props: StudioCrossDatasetReferenceInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioReferenceInput(props: StudioReferenceInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @hidden
 * @beta */
declare function StudioFileInput(props: FileInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @hidden
 * @beta */
declare function StudioImageInput(props: ImageInputProps): react597.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 * */
declare const SanityDefaultPreview: react597.NamedExoticComponent<SanityDefaultPreviewProps>;
/**
 * @internal
 * @beta
 *
...
declare function getPreviewValueWithFallback({
  ...
  title: react597.JSX.Element;
  subtitle: react597.JSX.Element;
  media: () => react597.JSX.Element;
};
/** @internal */
...
declare function ResourceCacheProvider({
  children
}: ResourceCacheProviderProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare function DocumentPreviewPresence(props: DocumentPreviewPresenceProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare const FieldPresenceInner: react597.NamedExoticComponent<FieldPresenceInnerProps>;
/** @internal */
...
/** @internal */
declare function FieldPresence(props: FieldPresenceProps): react597.JSX.Element;
/**
 * @internal
 * @hidden
...
declare function PresenceOverlay({
  children,
  margins
}: PresenceOverlayProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare function PresenceScope(props: PresenceScopeProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormField: react597.NamedExoticComponent<FormFieldProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref">>;
/** @internal */
...
/** @internal */
declare const FormFieldHeaderText: react597.NamedExoticComponent<FormFieldHeaderTextProps>;
/** @internal */
...
/** @internal */
declare const FormFieldSet: react597.ForwardRefExoticComponent<FormFieldSetProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & react597.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function FormFieldStatus({
  ...
  maxAvatars,
  position
}: FieldStatusProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare function FormFieldValidationStatus(props: FormFieldValidationStatusProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormInput: react597.NamedExoticComponent<(ArrayOfObjectsInputProps<{
  _key: string;
...
/** @internal */
declare const FieldActionMenu: react597.NamedExoticComponent<FieldActionMenuProps>;
...
/** @internal */
declare const FieldActionsProvider: react597.NamedExoticComponent<FieldActionsProviderProps>;
/** @internal */
 ...
 * @internal
 */
declare const FieldActionsResolver: react597.NamedExoticComponent<FieldActionsProps>;
/** @internal */
declare function useFieldActions(): FieldActionsContextValue;
/** @internal */
declare const HoveredFieldProvider: react597.NamedExoticComponent<{
  children?: react597.ReactNode;
}>;
/** @internal */
 ...
 * @hidden
 * @beta */
declare function ArrayOfObjectsFunctions<Item extends ObjectItem, TSchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<Item, TSchemaType>): react597.JSX.Element | null;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfObjectsInput(props: ArrayOfObjectsInputProps): react597.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function VirtualizerScrollInstanceProvider(props: VirtualizerScrollInstanceProviderProps): react597.JSX.Element;
/**
 * @hidden
 ...
 * @beta
 */
declare function ArrayOfObjectOptionsInput(props: ArrayOfObjectsInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfOptionsInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react597.JSX.Element;
/**
 ...
 * @beta
 */
declare function ArrayOfPrimitiveOptionsInput(props: ArrayOfPrimitivesInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
declare function ArrayOfPrimitivesFunctions<MemberType extends string | boolean | number, SchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<MemberType, SchemaType>): react597.JSX.Element | null;
...
declare class ArrayOfPrimitivesInput extends PureComponent<ArrayOfPrimitivesInputProps, State> {
  ...
  renderArrayItem: (props: Omit<PrimitiveItemProps, "renderDefault">) => react597.JSX.Element;
  render(): react597.JSX.Element;
}
/**
 ...
 * @beta
 */
declare function UniversalArrayInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function BooleanInput(props: BooleanInputProps): react597.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare function DateInput(props: DateInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DateTimeInput(props: DateTimeInputProps): react597.JSX.Element;
 ...
 * @beta
 */
declare function EmailInput(props: EmailInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @beta
 */
declare function NumberInput(props: NumberInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta */
declare const ObjectInput: react597.NamedExoticComponent<ObjectInputProps<Record<string, any>, _sanity_types44.ObjectSchemaType>>;
/** @internal */
...
}, "ref"> & react597.RefAttributes<HTMLInputElement>>;
/**
 *
 * @hidden
 * @beta
 */
declare function SelectInput(props: StringInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function SlugInput(props: SlugInputProps): react597.JSX.Element;
/**
 * @hidden
 * @beta
 */
declare function StringInput(props: StringInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TagsArrayInput(props: TagsArrayInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TelephoneInput(props: TelephoneInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TextInput(props: TextInputProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function UrlInput(props: UrlInputProps): react597.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMember(props: ArrayOfObjectsMemberProps): react597.JSX.Element | null;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMembers(props: ArrayOfObjectsInputMembersProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfObjectsItem(props: MemberItemProps): react597.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfPrimitivesItem(props: PrimitiveMemberItemProps): react597.JSX.Element;
/** @internal */
...
/** @internal */
declare const MemberField: react597.NamedExoticComponent<MemberFieldProps>;
/** @internal */
declare function MemberFieldError(props: {
  member: FieldError;
}): react597.JSX.Element;
/** @internal */
declare const MemberFieldSet: react597.NamedExoticComponent<{
...
/** @internal */
declare const ObjectInputMember: react597.NamedExoticComponent<ObjectInputMemberProps>;
/** @internal */
 ...
 * @internal
 */
declare function ObjectInputMembers(props: ObjectMembersProps): react597.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare const TransformPatches: react597.NamedExoticComponent<{
 ...
 * @internal
 */
declare function createDefaultIcon(title: string, subtitle: string): react597.JSX.Element;
/**
 * @hidden
 * @beta */
