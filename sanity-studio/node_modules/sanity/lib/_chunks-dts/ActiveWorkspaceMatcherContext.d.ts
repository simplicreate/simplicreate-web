...
/** @internal */
declare function BetaBadge(props: BetaBadgeProps & Omit<HTMLProps<HTMLDivElement>, 'ref'>): react609.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const CommandList: react609.NamedExoticComponent<CommandListProps<any> & react609.RefAttributes<CommandListHandle>>;
 ...
 * @internal
 */
declare const Button: react609.ForwardRefExoticComponent<(Omit<Pick<ButtonProps, "as" | "icon" | "iconRight" | "justify" | "loading" | "mode" | "paddingLeft" | "paddingY" | "selected" | "tone" | "type" | "width"> & {
  ...
  size?: "default" | "large" | undefined;
  radius?: "full" | undefined;
} & IconButton & Omit<HTMLProps<HTMLButtonElement>, "as" | "size" | "title">, "ref">) & react609.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ContextMenuButton: react609.ForwardRefExoticComponent<ContextMenuButtonProps & Pick<HTMLProps<HTMLButtonElement>, "disabled" | "hidden" | "onClick"> & react609.RefAttributes<HTMLButtonElement>>;
/**
 ...
 * @internal
 */
declare const Chip: react609.ForwardRefExoticComponent<Omit<Omit<_sanity_ui15.ButtonProps & Omit<react609.HTMLProps<HTMLButtonElement>, "as" | "width">, "ref"> & react609.RefAttributes<HTMLButtonElement>, "ref"> & react609.RefAttributes<unknown>>;
/**
 *
 ...
 * @internal
 */
declare const VersionChip: react609.NamedExoticComponent<{
...
/** @internal */
declare function ChangeIndicator(props: ChangeIndicatorProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react609.JSX.Element;
/** @internal */
...
declare function ChangeConnectorRoot({
  ...
  onSetFocus,
  ...restProps
}: ChangeConnectorRootProps): react609.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const ChangeIndicatorsTracker: react609.MemoExoticComponent<typeof ChangeIndicatorsTrackerComponent>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare function CommentDeleteDialog(props: CommentDeleteDialogProps): react609.JSX.Element;
/**
 * @internal
 */
declare const CommentDisabledIcon: react609.ForwardRefExoticComponent<Omit<SVGProps<SVGSVGElement>, "ref"> & react609.RefAttributes<SVGSVGElement>>;
/**
 *
 ...
 * @hidden
 */
declare function LocaleProvider(props: PropsWithChildren): react609.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * @public
 */
declare function Translate(props: TranslationProps): react609.JSX.Element;
 ...
 * while reconnecting.
 */
declare function CommentsAuthoringPathProvider(props: CommentsAuthoringPathProviderProps): react609.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @beta
 */
declare const CommentsProvider: react609.NamedExoticComponent<CommentsProviderProps>;
 ...
 * @hidden
 */
declare const CommentsEnabledProvider: react609.NamedExoticComponent<CommentsEnabledProviderProps>;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsIntentProvider: react609.NamedExoticComponent<CommentsIntentProviderProps>;
 ...
 * @internal
 */
declare const CommentsSelectedPathProvider: react609.NamedExoticComponent<CommentsSelectedPathProviderProps>;
/**
 * @internal
 */
...
}: ActiveWorkspaceMatcherProps): react609.JSX.Element;
/** @internal */
...
declare function WorkspacesProvider({
  ...
  basePath,
  LoadingComponent
}: WorkspacesProviderProps): react609.JSX.Element;
/** @internal */
 ...
 * @hidden
 */
declare function AddonDatasetProvider(props: AddonDatasetSetupProviderProps): string | number | bigint | boolean | react609.JSX.Element | Iterable<react609.ReactNode> | Promise<string | number | bigint | boolean | Iterable<react609.ReactNode> | react609.ReactElement<unknown, string | react609.JSXElementConstructor<any>> | react609.ReactPortal | null | undefined> | null | undefined;
/**
 * @beta
 * @hidden
 */
...
declare function ColorSchemeProvider({
  ...
  onSchemeChange,
  scheme: schemeProp
}: ColorSchemeProviderProps): react609.JSX.Element;
/**
...
declare function ColorSchemeLocalStorageProvider({
  children,
  onSchemeChange
}: Pick<ColorSchemeProviderProps, 'children' | 'onSchemeChange'>): react609.JSX.Element;
/**
 ...
 * @internal
 */
declare const SearchHeader: react609.ForwardRefExoticComponent<SearchHeaderProps & react609.RefAttributes<HTMLInputElement>>;
...
declare function SearchPopover({
  ...
  previewPerspective,
  open
}: SearchPopoverProps): react609.JSX.Element;
...
declare function SearchResultItemPreview({
  ...
  showBadge,
  perspective
}: SearchResultItemPreviewProps): react609.JSX.Element;
/**
 * @internal
 */
...
declare function SearchProvider({
  ...
  disabledDocumentIds,
  canDisableAction
}: SearchProviderProps): react609.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare const SearchButton: react609.ForwardRefExoticComponent<SearchButtonProps & react609.RefAttributes<HTMLButtonElement>>;
...
declare function SearchDialog({
  ...
  onOpen,
  open
}: SearchDialogProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioLogo(props: LogoProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function StudioNavbar(props: Omit<NavbarProps, 'renderDefault'>): react609.JSX.Element;
/**
 * @hidden
 * @beta */
declare function StudioToolMenu(props: ToolMenuProps): react609.JSX.Element | null;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare const ToolLink: react609.ForwardRefExoticComponent<Omit<ToolLinkProps & Omit<HTMLProps<HTMLAnchorElement>, "href" | "name">, "ref"> & react609.RefAttributes<HTMLAnchorElement>>;
/**
 * @hidden
 * @beta */
...
declare function SourceProvider({
  children,
  ...props
}: SourceProviderProps): react609.JSX.Element;
/**
 * @internal
...
declare function StudioAnnouncementsCard({
  ...
  onCardClick,
  onCardDismiss
}: StudioAnnouncementCardProps): react609.JSX.Element;
...
declare function StudioAnnouncementsDialog({
  ...
  onClose,
  mode
}: StudioAnnouncementDialogProps): react609.JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * ```
 */
declare function StudioLayout(): react609.JSX.Element;
/**
 * @internal
 * The default Studio Layout component
 * */
declare function StudioLayoutComponent(): react609.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: StudioProviderProps): react609.JSX.Element;
 ...
 * @internal
 */
declare function UpsellDescriptionSerializer(props: DescriptionSerializerProps): react609.JSX.Element;
/** @internal */
...
declare function ErrorMessage({
  ...
  path,
  stack
}: ErrorMessageProps): react609.JSX.Element;
...
declare function WorkspaceLoaderBoundary({
  ...
  ...props
}: WorkspaceLoaderProps): react609.JSX.Element;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare const CommentsList: react609.NamedExoticComponent<CommentsListProps & react609.RefAttributes<HTMLDivElement>>;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare const CommentInput: react609.ForwardRefExoticComponent<CommentInputProps & react609.RefAttributes<CommentInputHandle>>;
 ...
 * @internal
 */
declare const CommentInlineHighlightSpan: react609.ForwardRefExoticComponent<Omit<CommentInlineHighlightSpanProps & react609.HTMLProps<HTMLSpanElement>, "ref"> & react609.RefAttributes<HTMLSpanElement>>;
/**
 * @internal
 * @hidden
 */
...
/** @internal */
declare const CollapseMenu: react609.ForwardRefExoticComponent<CollapseMenuProps & react609.RefAttributes<any>>;
/** @internal */
declare const AutoCollapseMenu: react609.ForwardRefExoticComponent<Omit<CollapseMenuProps, "children" | "collapsed"> & {
  menuOptions: react609.JSX.Element[];
} & react609.RefAttributes<HTMLDivElement>>;
/** @internal */
...
/** @internal */
declare const CollapseMenuButton: react609.ForwardRefExoticComponent<Omit<CollapseMenuButtonProps & Omit<HTMLProps<HTMLButtonElement>, "as" | "size">, "ref"> & react609.RefAttributes<HTMLButtonElement>>;
/** @internal */
 ...
 * @internal
 */
declare const ScrollContainer: react609.NamedExoticComponent<Omit<ScrollContainerProps<ElementType>, "ref"> & react609.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function EventsProvider({
  value,
  children
}: EventsProviderProps): react609.JSX.Element;
/**
 * @internal
 */
...
/** @internal */
declare function ChangeResolver(props: ChangeResolverProps): react609.JSX.Element | null;
/**
 * @internal
 * */
...
/** @internal */
declare const DiffCard: react609.ForwardRefExoticComponent<Omit<DiffCardProps & Omit<HTMLProps<HTMLElement>, "as" | "height">, "ref"> & react609.RefAttributes<unknown>>;
/** @internal */
...
declare class DiffErrorBoundary extends Component<DiffErrorBoundaryProps, DiffErrorBoundaryState> {
  ...
  render(): string | number | bigint | boolean | react609.JSX.Element | Iterable<ReactNode> | Promise<string | number | bigint | boolean | Iterable<ReactNode> | react609.ReactElement<unknown, string | react609.JSXElementConstructor<any>> | react609.ReactPortal | null | undefined> | null | undefined;
}
/** @internal */
...
/** @internal */
declare function DiffFromTo(props: DiffFromToProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare function DiffTooltip(props: DiffTooltipProps | DiffTooltipWithAnnotationsProps): react609.JSX.Element;
...
declare function Event$1({
  event,
  showChangesBy
}: TimelineItemProps): react609.JSX.Element;
/** @internal */
...
declare function FieldChange(props: {
  ...
  hidden?: boolean;
  addParentWrapper?: boolean;
} & HTMLAttributes<HTMLDivElement>): react609.JSX.Element | null;
/** @internal */
type FromToProps = {
  align?: 'top' | 'center' | 'bottom';
  layout?: 'grid' | 'inline';
...
/** @internal */
declare const FromTo: react609.ForwardRefExoticComponent<Omit<FromToProps, "ref"> & react609.RefAttributes<HTMLDivElement>>;
/** @internal */
type FromToArrowDirection = 'down' | 'right';
/** @internal */
declare function FromToArrow(props: {
  direction?: FromToArrowDirection;
} & TextProps & Omit<HTMLProps<HTMLDivElement>, 'children' | 'ref'>): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare function MetaInfo(props: MetaInfoProps): react609.JSX.Element;
/** @internal */
declare function NoChanges(): react609.JSX.Element;
/** @internal */
declare const RevertChangesButton: react609.ForwardRefExoticComponent<Omit<ButtonProps$1, "tooltipProps"> & Omit<HTMLProps<HTMLButtonElement>, "ref"> & {
  changeCount: number;
} & react609.RefAttributes<HTMLButtonElement>>;
...
declare function RevertChangesConfirmDialog({
  ...
  changeCount,
  referenceElement
}: RevertChangesConfirmDialogProps): react609.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function EditScheduleForm(props: PropsWithChildren<Props$2>): react609.JSX.Element;
/**
 * @internal
 */
...
declare function useScheduleAction(props: DocumentActionProps): {
  disabled: true;
  icon: react609.ForwardRefExoticComponent<Omit<react609.SVGProps<SVGSVGElement>, "ref"> & react609.RefAttributes<SVGSVGElement>>;
  label: string;
  title: react609.JSX.Element;
  dialog?: undefined;
  onHandle?: undefined;
} | {
  ...
  icon: react609.ForwardRefExoticComponent<Omit<react609.SVGProps<SVGSVGElement>, "ref"> & react609.RefAttributes<SVGSVGElement>>;
  onHandle: () => void;
  title: "" | react609.JSX.Element | null;
} | null;
...
/** @internal */
declare function GetHookCollectionState<Args, State>(props: GetHookCollectionStateProps<Args, State>): react609.JSX.Element;
/**
 * @hidden
 * @beta */
...
}: SingleDocReleaseProviderProps): react609.JSX.Element;
/**
...
declare function DocumentStatus({
  ...
  versions,
  singleLine
}: DocumentStatusProps$1): react609.JSX.Element;
/**
 * @internal
 */
...
declare function DocumentStatusIndicator({
  ...
  published,
  versions
}: DocumentStatusProps): react609.JSX.Element;
/**
 * @internal
 */
...
declare function Hotkeys({
  ...
  keys: hotKeys,
  ...props
}: HotkeysProps$1): react609.JSX.Element;
/** @internal */
...
declare function InsufficientPermissionsMessage({
  currentUser,
  context
}: InsufficientPermissionsMessageProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function IntentButton(props: IntentLinkProps & ButtonProps$1 & Omit<HTMLProps<HTMLButtonElement>, 'ref' | 'size' | 'as'>): react609.JSX.Element;
...
declare function LoadingBlock({
  ...
  showText,
  title
}: LoadingTestProps): react609.JSX.Element;
...
/** @internal */
declare function PopoverDialog(props: PopoverDialogProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare const PreviewCard: react609.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react609.RefAttributes<HTMLDivElement>>;
/**
 ...
 * @internal
 */
declare const ReferenceInputPreviewCard: styled_components_dist_types6.IStyledComponentBase<"web", styled_components4.FastOmit<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react609.RefAttributes<HTMLDivElement>, never>> & string & Omit<react609.ForwardRefExoticComponent<Omit<CardProps & Omit<HTMLProps<HTMLDivElement>, "height">, "ref"> & react609.RefAttributes<HTMLDivElement>>, keyof react609.Component<any, {}, any>>;
/**
 ...
 * @hidden
 * @beta */
declare function CompactPreview(props: CompactPreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DefaultPreview(props: DefaultPreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DetailPreview(props: DetailPreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function MediaPreview(props: MediaPreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function BlockImagePreview(props: BlockImagePreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
declare function BlockPreview(props: Omit<PreviewProps<'block'>, 'renderDefault'>): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function InlinePreview(props: InlinePreviewProps): react609.JSX.Element;
 ...
 * @hidden
 * @beta */
declare function TemplatePreview(props: TemplatePreviewProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
...
declare function RelativeTime({
  time,
  ...options
}: RelativeTimeProps): react609.JSX.Element;
 ...
 */
declare function Resizable(props: ResizableProps & BoxProps & Omit<HTMLProps<HTMLDivElement>, 'as'>): react609.JSX.Element;
/**
 * @hidden
 * @beta */
...
/** @hidden @beta */
declare const StatusButton: react609.ForwardRefExoticComponent<(StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, "disabled" | "ref" | "size" | "title">) & react609.RefAttributes<HTMLButtonElement>>;
/** @internal */
...
/** @internal */
declare const TextWithTone: react609.ForwardRefExoticComponent<Omit<TextWithToneProps, "ref"> & react609.RefAttributes<HTMLDivElement>>;
/** @internal */
declare const TooltipOfDisabled: react609.ForwardRefExoticComponent<Omit<_sanity_ui15.TooltipProps, "arrow" | "padding" | "shadow"> & {
 ...
 */
declare const ImperativeToast: react609.ForwardRefExoticComponent<react609.RefAttributes<unknown>>;
/**
 ...
 * @beta
 */
declare const AvatarSkeleton: styled_components_dist_types6.IStyledComponentBase<"web", styled_components_dist_types6.Substitute<Omit<_sanity_ui15.SkeletonProps & react609.HTMLProps<HTMLDivElement>, "ref"> & react609.RefAttributes<HTMLDivElement>, AvatarSkeletonProps>> & string & Omit<react609.ForwardRefExoticComponent<Omit<_sanity_ui15.SkeletonProps & react609.HTMLProps<HTMLDivElement>, "ref"> & react609.RefAttributes<HTMLDivElement>>, keyof react609.Component<any, {}, any>>;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function UserAvatar(props: UserAvatarProps): react609.JSX.Element;
/**
 * @internal
...
/** @internal */
declare const FormCallbacksProvider: react609.NamedExoticComponent<FormCallbacksValue & {
  children: ReactNode;
}>;
/** @internal */
 ...
 * @alpha
 */
declare function FormBuilder(props: FormBuilderProps): react609.JSX.Element;
/**
 ...
 * @alpha This API might change.
 */
declare function FormProvider(props: FormProviderProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioCrossDatasetReferenceInput(props: StudioCrossDatasetReferenceInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function StudioReferenceInput(props: StudioReferenceInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @hidden
 * @beta */
declare function StudioFileInput(props: FileInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @hidden
 * @beta */
declare function StudioImageInput(props: ImageInputProps): react609.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 * */
declare const SanityDefaultPreview: react609.NamedExoticComponent<SanityDefaultPreviewProps>;
/**
 * @internal
 * @beta
 *
...
declare function getPreviewValueWithFallback({
  ...
  title: react609.JSX.Element;
  subtitle: react609.JSX.Element;
  media: () => react609.JSX.Element;
};
/** @internal */
...
declare function ResourceCacheProvider({
  children
}: ResourceCacheProviderProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare function DocumentPreviewPresence(props: DocumentPreviewPresenceProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare const FieldPresenceInner: react609.NamedExoticComponent<FieldPresenceInnerProps>;
/** @internal */
...
/** @internal */
declare function FieldPresence(props: FieldPresenceProps): react609.JSX.Element;
/**
 * @internal
 * @hidden
...
declare function PresenceOverlay({
  children,
  margins
}: PresenceOverlayProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare function PresenceScope(props: PresenceScopeProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormField: react609.NamedExoticComponent<FormFieldProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref">>;
/** @internal */
...
/** @internal */
declare const FormFieldHeaderText: react609.NamedExoticComponent<FormFieldHeaderTextProps>;
/** @internal */
...
/** @internal */
declare const FormFieldSet: react609.ForwardRefExoticComponent<FormFieldSetProps & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & react609.RefAttributes<HTMLDivElement>>;
/** @internal */
...
declare function FormFieldStatus({
  ...
  maxAvatars,
  position
}: FieldStatusProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare function FormFieldValidationStatus(props: FormFieldValidationStatusProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare const FormInput: react609.NamedExoticComponent<(ArrayOfObjectsInputProps<{
  _key: string;
...
/** @internal */
declare const FieldActionMenu: react609.NamedExoticComponent<FieldActionMenuProps>;
...
/** @internal */
declare const FieldActionsProvider: react609.NamedExoticComponent<FieldActionsProviderProps>;
/** @internal */
 ...
 * @internal
 */
declare const FieldActionsResolver: react609.NamedExoticComponent<FieldActionsProps>;
/** @internal */
declare function useFieldActions(): FieldActionsContextValue;
/** @internal */
declare const HoveredFieldProvider: react609.NamedExoticComponent<{
  children?: react609.ReactNode;
}>;
/** @internal */
 ...
 * @hidden
 * @beta */
declare function ArrayOfObjectsFunctions<Item extends ObjectItem, TSchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<Item, TSchemaType>): react609.JSX.Element | null;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfObjectsInput(props: ArrayOfObjectsInputProps): react609.JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function VirtualizerScrollInstanceProvider(props: VirtualizerScrollInstanceProviderProps): react609.JSX.Element;
/**
 * @hidden
 ...
 * @beta
 */
declare function ArrayOfObjectOptionsInput(props: ArrayOfObjectsInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function ArrayOfOptionsInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react609.JSX.Element;
/**
 ...
 * @beta
 */
declare function ArrayOfPrimitiveOptionsInput(props: ArrayOfPrimitivesInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
declare function ArrayOfPrimitivesFunctions<MemberType extends string | boolean | number, SchemaType extends ArraySchemaType>(props: ArrayInputFunctionsProps<MemberType, SchemaType>): react609.JSX.Element | null;
...
declare class ArrayOfPrimitivesInput extends PureComponent<ArrayOfPrimitivesInputProps, State> {
  ...
  renderArrayItem: (props: Omit<PrimitiveItemProps, "renderDefault">) => react609.JSX.Element;
  render(): react609.JSX.Element;
}
/**
 ...
 * @beta
 */
declare function UniversalArrayInput(props: ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 */
declare function BooleanInput(props: BooleanInputProps): react609.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare function DateInput(props: DateInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function DateTimeInput(props: DateTimeInputProps): react609.JSX.Element;
 ...
 * @beta
 */
declare function EmailInput(props: EmailInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta
 */
 ...
 * @beta
 */
declare function NumberInput(props: NumberInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta */
declare const ObjectInput: react609.NamedExoticComponent<ObjectInputProps<Record<string, any>, _sanity_types44.ObjectSchemaType>>;
/** @internal */
 ...
 * @internal
 */
declare function CreateButton(props: Props): react609.JSX.Element;
/**
 * @internal
 */
declare const ReferenceAutocomplete: react609.ForwardRefExoticComponent<Omit<_sanity_ui15.AutocompleteProps<_sanity_ui15.BaseAutocompleteOption> & Omit<react609.HTMLProps<HTMLInputElement>, "aria-activedescendant" | "aria-autocomplete" | "aria-expanded" | "aria-owns" | "as" | "autoCapitalize" | "autoComplete" | "autoCorrect" | "id" | "inputMode" | "onChange" | "onSelect" | "popover" | "prefix" | "ref" | "role" | "spellCheck" | "type" | "value"> & {
...
}, "ref"> & react609.RefAttributes<HTMLInputElement>>;
/**
 *
 * @hidden
 * @beta
 */
declare function SelectInput(props: StringInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function SlugInput(props: SlugInputProps): react609.JSX.Element;
/**
 * @hidden
 * @beta
 */
declare function StringInput(props: StringInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TagsArrayInput(props: TagsArrayInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TelephoneInput(props: TelephoneInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TextInput(props: TextInputProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function UrlInput(props: UrlInputProps): react609.JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMember(props: ArrayOfObjectsMemberProps): react609.JSX.Element | null;
/** @internal */
 ...
 * @internal
 */
declare function ArrayOfObjectsInputMembers(props: ArrayOfObjectsInputMembersProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfObjectsItem(props: MemberItemProps): react609.JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function ArrayOfPrimitivesItem(props: PrimitiveMemberItemProps): react609.JSX.Element;
/** @internal */
...
/** @internal */
declare const MemberField: react609.NamedExoticComponent<MemberFieldProps>;
/** @internal */
declare function MemberFieldError(props: {
  member: FieldError;
}): react609.JSX.Element;
/** @internal */
declare const MemberFieldSet: react609.NamedExoticComponent<{
...
/** @internal */
declare const ObjectInputMember: react609.NamedExoticComponent<ObjectInputMemberProps>;
/** @internal */
 ...
 * @internal
 */
declare function ObjectInputMembers(props: ObjectMembersProps): react609.JSX.Element;
/**
 ...
 * @hidden
 * @beta */
declare const TransformPatches: react609.NamedExoticComponent<{
 ...
 * @internal
 */
declare function createDefaultIcon(title: string, subtitle: string): react609.JSX.Element;
/**
 * @hidden
 * @beta */
